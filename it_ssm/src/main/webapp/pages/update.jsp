          ...
          <div class="form-group">
            <label for="address">籍贯：</label>
             <select name="address" id="address" class="form-control" >
                 ...
                 <option value="黑木崖" <c:if test="${user.address == '黑木崖'}">selected</c:if>>黑木崖</option>
                 <option value="香港" <c:if test="${user.address == '香港'}">selected</c:if>>香港</option>
                 <option value="华山" <c:if test="${user.address == '华山'}">selected</c:if>>华山</option>
                 <option value="嵩山" <c:if test="${user.address == '嵩山'}">selected</c:if>>嵩山</option>
            </select>
          </div>
